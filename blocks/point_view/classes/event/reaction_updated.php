...
/**
 * Event triggered when a user updates their reaction on a module.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reaction_updated extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has updated their reaction" .
    ...
    public static function get_name() {
        return get_string('eventreactionupdated', 'block_point_view');
    }
