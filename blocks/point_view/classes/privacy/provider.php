...
class provider implements \core_privacy\local\metadata\provider,
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        $sql = 'SELECT DISTINCT ctx.id
                  ...
                  JOIN {context} ctx ON ctx.instanceid = bpv.userid AND ctx.contextlevel = :contextlevel
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        if (!empty($pointviewdata)) {
            ...
            \core_privacy\local\request\writer::with_context($contextlist->current())->export_data(
                [ get_string('pluginname', 'block_point_view') ],
                $data
            );
        }
    }
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $sql = "SELECT bpv.userid as userid
                  FROM {block_point_view} bpv
                  JOIN {context} ctx ON ctx.instanceid = bpv.userid AND ctx.contextlevel = :contextuser
